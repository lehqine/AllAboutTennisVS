Module mod_globals_a180970

    Public username As String

    Public myconnection As String = "Provider=Microsoft.ACE.OLEDB.12.0;Data Source=DB_AllAboutTennis_A180970.accdb;Persist Security Info=False;"
